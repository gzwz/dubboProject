...
public class LogAspect {
    ...
    private void log(JoinPoint point, Object obj) {
        ...
        if(sign.equals("Start")) {
            /* 打印入参 */
            log.info(LogInfo.PAY.getName() + ": " + interfaceName + "." + methodNam + "(" + methodName + ") - 调用开始");
            ...
            /* 打印出参*/
           /* log.info(LogInfo.PAY.getName() + ": " + interfaceName + "." + methodNam + "(" + methodName + ") - 调用结束");
            for(Object param : point.getArgs()) {
                sb.append(param + " ");
            }
            ...
            /* 打印异常信息*/
            log.error(LogInfo.PAY.getName() + ": " + interfaceName + LogInfo.InterfaceException.getName(), obj);
        }
    }
}
